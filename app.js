...
const { filterQuery, getTodo, getTodos, valiDate, valiDateTodo, createTodo } = appLib;
...
server.post("/todos/", valiDateTodo, createTodo, async (request, response) => {});
server.put("/todos/:todoId/", valiDatePutTodo, updateTodo, async (request, response) => {});
